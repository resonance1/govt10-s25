...
1.4 Create a new binary variable in the dataset that is set to 1 if the attack resulted in the leaders death, and 0 otherwise. What proportion of attacks resulted in the leaders' death? 
